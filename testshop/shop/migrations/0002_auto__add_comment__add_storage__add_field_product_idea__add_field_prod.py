...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('shop_comment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Product'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('content', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, null=True, blank=True)),
        ))
        db.send_create_signal('shop', ['Comment'])

        # Adding model 'Storage'
        db.create_table('shop_storage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Product'])),
        ...
        db.send_create_signal('shop', ['Storage'])

        # Adding field 'Product.idea'
        db.add_column('shop_product', 'idea',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.delivery'
        db.add_column('shop_product', 'delivery',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table('shop_comment')

        # Deleting model 'Storage'
        db.delete_table('shop_storage')

        # Deleting field 'Product.idea'
        db.delete_column('shop_product', 'idea')

        # Deleting field 'Product.delivery'
        db.delete_column('shop_product', 'delivery')
