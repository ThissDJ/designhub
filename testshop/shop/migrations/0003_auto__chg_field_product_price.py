...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('shop_product', 'price', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Product.price'
        db.alter_column('shop_product', 'price', self.gf('django.db.models.fields.PositiveIntegerField')())
