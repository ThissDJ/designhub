...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.finish'
        db.add_column('shop_product', 'finish',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.time_discount'
        db.add_column('shop_product', 'time_discount',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Product.original_price'
        db.add_column('shop_product', 'original_price',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.finish'
        db.delete_column('shop_product', 'finish')

        # Deleting field 'Product.time_discount'
        db.delete_column('shop_product', 'time_discount')

        # Deleting field 'Product.original_price'
        db.delete_column('shop_product', 'original_price')
    ...
    models = {
        ...
        'shop.product': {
            ...
            'finish': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'original_price': ('django.db.models.fields.FloatField', [], {'default': '0.0', 'null': 'True', 'blank': 'True'}),
            'price': ('django.db.models.fields.FloatField', [], {}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
            'sort': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1', 'null': 'True', 'blank': 'True'}),
            'time_discount': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'shop.productimage': {
