...
class RegistrationManager(models.Manager):
    ...
    def create_inactive_user(self, username, password, email,
        ...
        if send_email:
            ...
            send_mail(subject, message, settings.DEFAULT_FROM_EMAIL, [new_user.email], auth_user= settings.DEFAULT_AUTH_USER,  auth_password= settings.DEFAULT_AUTH_PASSWORD)
        return new_user
