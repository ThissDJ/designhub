...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Designer.active'
        db.add_column('localsite_designer', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Designer.featured'
        db.add_column('localsite_designer', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Designer.active'
        db.delete_column('localsite_designer', 'active')

        # Deleting field 'Designer.featured'
        db.delete_column('localsite_designer', 'featured')
