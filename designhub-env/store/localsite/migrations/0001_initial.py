...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('localsite_designer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('localsite', ['Designer'])

        # Adding model 'Brand'
        db.create_table('localsite_brand', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('designer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['localsite.Designer'], null=True, blank=True)),
        ))
        db.send_create_signal('localsite', ['Brand'])

        # Adding model 'DesignerImage'
        db.create_table('localsite_designerimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('designer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['localsite.Designer'], null=True, blank=True)),
        ...
        db.send_create_signal('localsite', ['DesignerImage'])

        # Adding model 'MyNewProduct'
        db.create_table('localsite_mynewproduct', (
            ('product', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['product.Product'], unique=True, primary_key=True)),
            ('designer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['localsite.Designer'], null=True, blank=True)),
            ('brand', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['localsite.Brand'], null=True, blank=True)),
            ('concept', self.gf('django.db.models.fields.TextField')(max_length=2000, null=True, blank=True)),
        ))
        db.send_create_signal('localsite', ['MyNewProduct'])


    def backwards(self, orm):
        # Deleting model 'Designer'
        db.delete_table('localsite_designer')

        # Deleting model 'Brand'
        db.delete_table('localsite_brand')

        # Deleting model 'DesignerImage'
        db.delete_table('localsite_designerimage')

        # Deleting model 'MyNewProduct'
        db.delete_table('localsite_mynewproduct')
    ...
    models = {
        'localsite.brand': {
            ...
            'designer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['localsite.Designer']", 'null': 'True', 'blank': 'True'}),
        ...
        'localsite.designerimage': {
            'Meta': {'ordering': "['sort']", 'object_name': 'DesignerImage'},
        ...
        'localsite.mynewproduct': {
            'Meta': {'object_name': 'MyNewProduct'},
            'brand': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['localsite.Brand']", 'null': 'True', 'blank': 'True'}),
            'concept': ('django.db.models.fields.TextField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
            'designer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['localsite.Designer']", 'null': 'True', 'blank': 'True'}),
