...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MyNewProduct.ship'
        db.add_column('localsite_mynewproduct', 'ship',
                      self.gf('django.db.models.fields.TextField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'MyNewProduct.featured'
        db.add_column('localsite_mynewproduct', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MyNewProduct.ship'
        db.delete_column('localsite_mynewproduct', 'ship')

        # Deleting field 'MyNewProduct.featured'
        db.delete_column('localsite_mynewproduct', 'featured')
    ...
    models = {
        ...
        'localsite.designer': {
            ...
            'artist': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        'localsite.mynewproduct': {
            ...
            'featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'preorder': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'product': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['product.Product']", 'unique': 'True', 'primary_key': 'True'}),
            'ship': ('django.db.models.fields.TextField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'})
        },
        'product.category': {
