...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MyNewProduct.preorder'
        db.add_column('localsite_mynewproduct', 'preorder',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MyNewProduct.end'
        db.add_column('localsite_mynewproduct', 'end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MyNewProduct.preorder'
        db.delete_column('localsite_mynewproduct', 'preorder')

        # Deleting field 'MyNewProduct.end'
        db.delete_column('localsite_mynewproduct', 'end')
