...
def find_product_template(product, producttypes=None):
    ...
    if 'PreOrderProduct' in producttypes:
        producttypesExceptPreOrderProduct = ['%s' %x.lower() for x in producttypes if x.lower() != 'preorderproduct' ]
        if len(producttypesExceptPreOrderProduct):
            templates = ["product/detail_preorderproduct_%s.html" % x.lower() for x in producttypesExceptPreOrderProduct]
        else:
            templates = ["product/detail_preorderproduct.html"]
    else:
