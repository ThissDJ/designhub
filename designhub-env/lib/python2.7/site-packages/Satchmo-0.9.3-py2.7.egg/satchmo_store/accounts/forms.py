...
#    error_messages.update({'invalid_login': _("Please enter a correct email and password. "
#                           "Note that both fields are case-sensitive.")})
    ...
    def __init__(self, request=None, *args, **kwargs):
        ...
        """
        self.error_messages.update({'invalid_login':_('Please enter a correct email and password. '
                                                      'Note that both fields are case-sensitive.')})
