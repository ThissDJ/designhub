...
#new_contact_created
#: Sent after a contact account has been created. 
#:
#: :param sender: An instance of ``satchmo_store.models.Contact``
#:
#: :param invitor: The invitor; type: Contact
#: :param invitee: ``satchmo_store.models.Contact``
new_contact_created = django.dispatch.Signal()